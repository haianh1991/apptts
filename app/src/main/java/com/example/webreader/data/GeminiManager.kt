...
class GeminiManager {
    ...
    suspend fun translateToVietnamese(
        ...
        val systemInstruction = """
            ...
            3. Đối với văn bản gốc là Tiếng Trung (truyện chữ Trung Quốc), hãy giữ nguyên cách xưng hô và đại từ nhân xưng theo phong cách Hán-Việt truyền thống (ví dụ: ngươi - ta, hắn, ả, chúng, ca, muội, tiểu muội, đại ca, nhị ca, thúc, bá, a di, thái thái, nãi nãi, công công, bà bà, tỷ tỷ, muội muội, đại nhân, phu nhân, sư phụ...). Tuyệt đối không dịch các từ này thành xưng hô hiện đại như "bạn - tôi", "anh ấy", "cô ấy", "bà".
